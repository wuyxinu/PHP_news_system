...
<table>
	<tr>
		<td width="80">标题:</td><td><?php echo $title?></td>
	</tr>
	<tr>
		<td width="80">内容:</td><td><?php echo $content?></td>
	</tr>
	<tr>
		<td width="80">附件:</td><td><a href="download.php?attachment=<?php echo urlencode($news['attachment']);?>"><?php echo $news['attachment'];?></a>
		</td>
	</tr>
	<tr>
		<td width="80">发布者:</td><td><?php echo $user['name'];?></td>
	</tr>
	<tr>
		<td width="80">类别:</td><td><?php echo $category['name'];?></td>
	</tr>
	<tr>
		<td width="80">发布时间:</td><td><?php echo $news['publish_time'];?></td>
	</tr>
	<tr>
		<td width="80">点击次数:</td><td><?php echo $news['clicked'];?></td>
	</tr>
</table>
